...
type ComboType = 'all' | 'none' | 'outer' | 'inner' | 'top' | 'right' | 'bottom' | 'left' | 'middle-horizontal' | 'middle-vertical';
type ComboTypeIndex = {
...
export const BorderComboIcon: React.FC<IComboIconProps> = ({ size, type }) => {
  return (
    <Icon size={size}>
